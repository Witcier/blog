<div class="box-body no-padding">
    ...
    <div class="mailbox-controls">
        ...
        <div class="btn-group">
            <a href="{{ route('dcat.admin.media-index', ['path' => $url['path'], 'view' => 'list']) }}" class="btn btn-default active"><i class="fa fa-list"></i></a>
            <a href="{{ route('dcat.admin.media-index', ['path' => $url['path'], 'view' => 'table']) }}" class="btn btn-default"><i class="fa fa-th"></i></a>
        </div>
