...
@section('content')
    <div id="wiki-edit-container" class="page-container">
        ...
        <div class="wiki-editor-md">
            <form id="form-editormd" method="post" action="{{route('dcat.admin.wiki.document.save',['wiki_project_id'=>$wiki_project_id])}}">
                @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" role="form" method="post"
                      action="{{route('dcat.admin.wiki.document.create',['wiki_project_id'=>$wiki_project_id])}}" id="form-document">
                    @csrf
                    {{--0 表示文档--}}
