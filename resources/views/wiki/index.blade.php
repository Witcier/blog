        ...
        <div class="fill-and-overflow-auto">
            <div class="col-sm-10 col-lg-10 col-sm-offset-1 wiki-project-container">
                @foreach($projects as $project)
                    <div class="col-sm-3">
                        <a class="wiki-doc-container" href="{{ route('wiki.document.detail',['project'=>$project->id]) }}">
                            <img class="wiki-doc-img" src="{{ config('filesystems.disks.admin.url').'/'.$project->thumb }}">
